...
| 平台 | 视频 | 音频 | 逐字稿 | 图文/文章 | 方法 |
|------|------|------|--------|----------|------|
| YouTube | ✅ | ✅ | ✅ | - | yt-dlp / Invidious fallback |
| Bilibili | ✅ | ✅ | ✅ | - | 直连playurl API / yt-dlp |
| B站课堂 (PUGV) | ✅ | ✅ | ✅ | - | PUGV API + 登录态 |
| 微信视频号 | ✅ | ✅ | ✅ | - | 在线解析服务 |
| 微信公众号 | - | - | - | ✅ | 直连HTTP |
| 小红书 | ✅ | ✅ | ✅ | ✅ | yt-dlp / Playwright |
| 抖音 | ✅ | ✅ | ✅ | - | Playwright API拦截 |
| X/Twitter | ✅ | ✅ | ✅ | ✅ | Playwright |
| 知乎 | - | - | - | ✅ | Playwright (非无头+stealth) |
| 小宇宙播客 | ✅ | ✅ | ✅ | ✅ | 直连HTTP下载 |
| 本地视频/音频 | ✅ | ✅ | ✅ | - | 直接转录 |
